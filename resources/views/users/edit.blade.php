                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group {{ $errors->has('designation') ? 'has-error' : '' }}">
                                        <label for="nome">Designation</label>
                                        <select class="form-control" name="designation">
                                            @if($user->designation == 'visitor')
                                            <option value="{{ $user->designation }}">Visitor</option>
                                            <option value="adm">Admin</option>
                                            @endif
                                            @if($user->designation == 'adm')
                                            <option value="{{ $user->designation }}">Admin</option>
